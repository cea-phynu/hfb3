...
{
  {
    ...
    ASSERT_NEAR(densn(0,  0), 6.030258e-10, precision);
    ASSERT_NEAR(densn(5, 17), 3.970772e-06, precision);
...

  {
    ...
    ASSERT_NEAR(densn(5, 17), 3.358334e-06, precision);
    ASSERT_NEAR(densp(0,  0), 1.786811e-08, precision);
    ASSERT_NEAR(densp(5, 17), 5.842519e-07, precision);
  }
}
